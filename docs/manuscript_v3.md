...
Cross-domain soil microbial coupling is strongly environment-structured, with secondary plant-diversity context and AMF-specific responsiveness signals

## Abstract
Cross-domain concordance among soil microbial communities can reflect shared environmental filtering, biological interaction, or both, but these explanations are difficult to separate in observational amplicon datasets. We synthesized completed results only (no rerun analyses) from coupling inference, environmental driver modeling, plant-diversity hypothesis comparisons, and Phase 5D integration for BAC↔ITS, EUK↔ITS, AMF↔ITS, and AMF↔EUK pairings across presence/absence and CLR branches. Top integrated coupling remained BAC↔ITS presence/absence (0.574), followed by EUK↔ITS presence/absence (0.538) and EUK↔ITS CLR (0.535) (Figure 1; Table 1) [R01, R02, R03, R04]. Environmental structure was substantial (dbRDA adjusted R² 0.188–0.278), with recurrent pH-centered ranking patterns (Figure 2; Table 3) [R05, R06, R07, R27]. Plant-diversity increments were smaller in magnitude but repeatable (Figure 3–5; Table 4), with alpha effects generally stronger than dark-diversity and completeness effects (mean alpha=0.013, dark=0.003, completeness=-0.004) [R08, R09, R10, R20]. AMF-linked pairs were not top-ranked in coupling magnitude but showed comparatively elevated plant-associated increments, supporting a responsiveness interpretation rather than a dominance interpretation [R11, R12, R22]. We therefore prioritize a conservative ecological reading: BAC↔ITS coupling is real at the association level but is plausibly dominated by shared environmental filtering; Mantel and Procrustes provide complementary structural evidence rather than interchangeable tests; and plant-diversity effects are biologically interpretable only when presented as modest, context-dependent increments rather than primary drivers [R13, R14, R15, R17, R18].
